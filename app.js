const exams = [
  { folder: 'ExamenModulo1', file: 'Examen_Modulo1_Zero_Trust_Exchange.txt', name: 'Módulo 1 - Zero Trust Exchange' },
  { folder: 'Examen2', file: 'Examen2_User_Management_Zscaler.txt', name: 'Módulo 2 - User Management' },
  { folder: 'Examen3', file: 'Examen3_Device_Management_Zscaler.txt', name: 'Módulo 3 - Device Management' }
];
